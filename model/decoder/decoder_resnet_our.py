...
class Decoder(nn.Module):
    def __init__(self, channels):
        ...
        self.pyramid_pooling = PyramidPooling(2048, channels)
        self.sfa1 = SFA(2048, channels)
        self.sfa2 = SFA(1024, channels)
        self.sft1 = SFTA(512, channels)
        self.sft2 = SFTA(256, channels)
