...
class CrossStrengthen(nn.Module):
    def __init__(self, dim, num_heads=8, bias=False, LayerNorm_type='WithBias'):
        ...
        self.qkvx2conv = nn.Conv2d(dim, dim, kernel_size=3, stride=5, padding=1, groups=dim, bias=bias)
        self.qkvx3conv = nn.Conv2d(dim, dim, kernel_size=3, stride=5, padding=1, groups=dim, bias=bias)
        ...
        self.qkvy1conv = nn.Conv2d(dim, dim, kernel_size=3, stride=5, padding=1, groups=dim, bias=bias)
